 ...
 *
 * Symptom: in `gogeta --tui`, typing into the composer until the input
 ...
 */
import { wrapAnsi } from '@gogeta/ink'
...
const USER_REPORT_MESSAGE =
  ...
  'im in cursor terminal using gogeta --tui and as i type multiline my caret at the end will often ' +
