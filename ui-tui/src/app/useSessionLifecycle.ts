...
import type { ScrollBoxHandle } from '@gogeta/ink'
import { evictInkCaches } from '@gogeta/ink'
...
export const writeActiveSessionFile = (sessionId: null | string, file = process.env.GOGETA_TUI_ACTIVE_SESSION_FILE) => {
  if (!file || !sessionId) {
    return
  }
