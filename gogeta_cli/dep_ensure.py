...
def _has_gogeta_agent_browser() -> bool:
    ...
    # install.sh installs globally into $GOGETA_HOME/node/bin/ via npm -g --prefix
...
def ensure_dependency(
    ...
    if shell == "powershell":
        ...
        cmd = [
            ...
            "-File", str(script),
            "-Ensure", dep,
            "-GogetaHome", str(get_gogeta_home()),
        ]
    else:
