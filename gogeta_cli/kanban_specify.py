...
Used by ``gogeta kanban specify [task_id | --all]``. Takes a task that
...
* This module intentionally mirrors ``gogeta_cli/goals.py`` — same aux
...
GOGETA_KANBAN_SPECIFY_MAX_TOKENS = max(

    1500,

    env_int("GOGETA_KANBAN_SPECIFY_MAX_TOKENS", 6000),
...
_SYSTEM_PROMPT = """You are the Kanban triage specifier for the Gogeta Agent board.
...
def _profile_author() -> str:
    ...
    """Mirror of ``gogeta_cli.kanban._profile_author``. Kept local to

    avoid a circular import when kanban.py imports this module."""

    return (

        os.environ.get("GOGETA_PROFILE")
    ...
    *,
    ...
    try:
        ...
        resp = client.chat.completions.create(
            ...
            max_tokens=GOGETA_KANBAN_SPECIFY_MAX_TOKENS,
