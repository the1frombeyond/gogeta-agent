...
Single source of truth for provider identity in Gogeta Agent.
...
2. **Gogeta overlays** — transport type, auth patterns, aggregator flags,
...
# Gogeta-specific metadata that models.dev doesn't provide.
...
class GogetaOverlay:
    ...
    """Gogeta-specific provider metadata layered on top of models.dev."""
...
GOGETA_OVERLAYS: Dict[str, GogetaOverlay] = {

    "openrouter": GogetaOverlay(
    ...
    "nous": GogetaOverlay(
        ...
        base_url_override="https://inference-api.gogeta.ai/v1",

    ),

    "openai-codex": GogetaOverlay(
    ...
    "qwen-oauth": GogetaOverlay(
        ...
        base_url_env_var="GOGETA_QWEN_BASE_URL",

    ),

    "google-gemini-cli": GogetaOverlay(
    ...
    "alibaba-coding-plan": GogetaOverlay(
    ...
    "tencent-tokenhub": GogetaOverlay(
...
class ProviderDef:
    ...
    source: str = ""                      # "models.dev", "gogeta", "user-config"
...
def get_provider(name: str) -> Optional[ProviderDef]:
    ...
    Resolution order:
      ...
      1. Gogeta overlays (for providers not in models.dev: nous, openai-codex, etc.)

      2. models.dev catalog + Gogeta overlay
    ...
    overlay = GOGETA_OVERLAYS.get(canonical)
    ...
    if mdev_info is not None:
        ...
        # Combine env vars: models.dev env + gogeta extra
    ...
    if overlay is not None:
        ...
        # Gogeta-only provider (not in models.dev)
...
def determine_api_mode(provider: str, base_url: str = "") -> str:
    ...
    # Direct provider checks for providers not in GOGETA_OVERLAYS
