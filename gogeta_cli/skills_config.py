"""
Skills configuration for Gogeta Agent.
`gogeta skills` enters this module.

Toggle individual skills or categories on/off, globally or per-platform.
Config stored in ~/.gogeta/config.yaml under:
...
from gogeta_cli.config import cfg_get, load_config, save_config
from gogeta_cli.colors import Colors, color
from gogeta_cli.platforms import PLATFORMS as _PLATFORMS
