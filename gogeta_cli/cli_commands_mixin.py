...
``cli.py``'s ``GogetaCLI`` class. ``GogetaCLI`` inherits ``CLICommandsMixin`` so
...
from gogeta_constants import display_gogeta_home, is_termux as _is_termux_environment
...
class CLICommandsMixin:
    ...
    def _handle_skills_command(self, cmd: str):
        ...
        if args and args[0].lower() in {"pending", "approve", "apply", "reject",
            ...
            from gogeta_cli.write_approval_commands import handle_pending_subcommand
