...
Invoked by ``gogeta kanban decompose [task_id | --all]`` and the
...
_SYSTEM_PROMPT = """You are the Kanban decomposer for the Gogeta Agent board.
...
def _profile_author() -> str:
    """Mirror of ``gogeta_cli.kanban._profile_author``."""
    return (
