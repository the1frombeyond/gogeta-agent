...
Used by ``gogeta profile describe <name> --auto`` and the dashboard's
...
Design notes
------------
- Mirrors the shape of ``gogeta_cli/kanban_specify.py``: lazy aux
...
_SYSTEM_PROMPT = """You are a profile-describer for the Gogeta Agent kanban board.
...
Rules:
  ...
  - Never write "Gogeta Agent profile" or other meta-narration.
    ...
    *,
    ...
    try:
        if canon == "default":
            ...
            profile_dir = Path(get_gogeta_home())
        else:
