...
from gogeta_cli.proxy.adapters.base import UpstreamAdapter, UpstreamCredential
...
def create_app(adapter: UpstreamAdapter) -> "web.Application":
    ...
    if not AIOHTTP_AVAILABLE:
        raise RuntimeError(
            "aiohttp is required for `gogeta proxy`. Install with: "
            "pip install 'gogeta-agent[messaging]' or `pip install aiohttp`."
        )
