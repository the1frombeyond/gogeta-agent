"""``gogeta slack`` subcommand parser.
...
def build_slack_parser(subparsers, *, cmd_slack: Callable) -> None:
    ...
    slack_parser = subparsers.add_parser(
        ...
        description="Slack integration helpers for Gogeta.",
    )
    ...
    slack_manifest.add_argument(
        ...
        "writes to $GOGETA_HOME/slack-manifest.json.",
    )
    slack_manifest.add_argument(
        "--name",
        default=None,
        help='Bot display name (default: "Gogeta")',
    )
    slack_manifest.add_argument(
        "--description",
        default=None,
