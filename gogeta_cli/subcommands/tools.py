"""``gogeta tools`` subcommand parser.
...
def build_tools_parser(subparsers, *, cmd_tools: Callable) -> None:
    ...
    tools_parser = subparsers.add_parser(
        ...
        description=(
            ...
            "Run 'gogeta tools' with no subcommand for the interactive configuration UI."
        ),
    )
    ...
    # gogeta tools list [--platform cli]
    ...
    # gogeta tools disable <name...> [--platform cli]
    ...
    # gogeta tools enable <name...> [--platform cli]
    ...
    tools_postsetup_p = tools_sub.add_parser(
        ...
        description=(
            ...
            "same step `gogeta tools` runs after you pick a provider that\n"
