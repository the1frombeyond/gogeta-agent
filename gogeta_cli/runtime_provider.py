...
def _config_base_url_trustworthy_for_bare_custom(cfg_base_url: str, cfg_provider: str) -> bool:
    ...
    try:
        ...
        from gogeta_cli.auth import resolve_provider as _resolve_provider
...
def _copilot_runtime_api_mode(model_cfg: Dict[str, Any], api_key: str) -> str:
    ...
    try:
        ...
        from gogeta_cli.models import copilot_model_api_mode
...
_VALID_API_MODES = {
    ...
    # instead of Gogeta' tool dispatch. Gated behind config key
    ...
    if provider == "openai-codex":
        ...
        if effective_model and api_mode != "anthropic_messages":
            ...
            try:
                ...
                from gogeta_cli.models import azure_foundry_model_api_mode
        ...
        if provider in {"opencode-zen", "opencode-go"}:
            ...
            from gogeta_cli.models import opencode_model_api_mode
...
def resolve_requested_provider(requested: Optional[str] = None) -> str:
    ...
    env_provider = os.getenv("GOGETA_INFERENCE_PROVIDER", "").strip().lower()
...
def _get_named_custom_provider(requested_provider: str) -> Optional[Dict[str, Any]]:
    ...
    if not requested_norm.startswith("custom:"):
        ...
        try:
            ...
            # the built-in. See tests/gogeta_cli/test_runtime_provider_resolution.py
    ...
    *,
    ...
    if not base_url:
        ...
        raise AuthError(
            ...
            "Azure Foundry requires a base URL. Set it via 'gogeta model' or "
    ...
    if provider == "nous":
        ...
        api_key = explicit_api_key or (
            ...
            if _agent_key_is_usable(
                ...
                max(60, env_int("GOGETA_NOUS_MIN_KEY_TTL_SECONDS", 1800)),
...
def resolve_runtime_provider(
    ...
    *,
    ...
    if pool and pool.has_credentials():
        ...
        # non-runtime contexts like `gogeta auth list`).  If the key is
        ...
        if provider == "nous" and entry is not None and pool_api_key:
            ...
            min_ttl = max(60, env_int("GOGETA_NOUS_MIN_KEY_TTL_SECONDS", 1800))
    ...
    if provider == "openai-codex":
        ...
        try:
            ...
            return {
                ...
                "source": creds.get("source", "gogeta-auth-store"),
    ...
    if provider == "minimax-oauth":
        ...
        if pconfig and pconfig.auth_type == "oauth_minimax":
            ...
            from gogeta_cli.auth import resolve_minimax_oauth_runtime_credentials
    ...
    if provider == "anthropic":
        ...
        if _is_azure_endpoint:
            ...
            # chain.  Accept both `key_env` (Gogeta canonical — matches the

            # custom_providers field name) and `api_key_env` (documented in the

            # Azure Foundry guide and read by most Gogeta-compatible importers).
