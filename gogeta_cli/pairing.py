...
Usage:
    gogeta pairing list              # Show all pending + approved users
    gogeta pairing approve <platform> <code>  # Approve a pairing code
    gogeta pairing revoke <platform> <user_id> # Revoke user access
    gogeta pairing clear-pending     # Clear all expired/pending codes
"""

def pairing_command(args):
    """Handle gogeta pairing subcommands."""
    ...
    if action == "list":
        ...
        print("Usage: gogeta pairing {list|approve|revoke|clear-pending}")
        print("Run 'gogeta pairing --help' for details.")
...
def _cmd_approve(store, platform: str, code: str):
    ...
    if result:
        ...
        print(
            ...
            "~/.gogeta/platforms/pairing/_rate_limits.json\n".format(platform)
        )
    else:
        print(f"\n  Code '{code}' not found or expired for platform '{platform}'.")
        print("  Run 'gogeta pairing list' to see pending codes.\n")
