# Streaming LLM Response Support for Gogeta Agent
...
```
GOGETA_STREAMING_ENABLED=true    # Master switch via env
```
...
try:
    ...
    pass
# Env var override
if os.getenv("GOGETA_STREAMING_ENABLED", "").lower() in ("true", "1", "yes"):
...
| `gogeta_cli/config.py` | 1 | +streaming config defaults |
