...
Config: ~/.gogeta/feishu_comment_rules.json (mtime-cached, hot-reload).
Pairing store: ~/.gogeta/feishu_comment_pairing.json.
"""
...
# ---------------------------------------------------------------------------
#
# Uses the canonical ``get_gogeta_home()`` helper (GOGETA_HOME-aware and
...
RULES_FILE = get_gogeta_home() / "feishu_comment_rules.json"
PAIRING_FILE = get_gogeta_home() / "feishu_comment_pairing.json"
