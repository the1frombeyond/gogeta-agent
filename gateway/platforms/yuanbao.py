...
try:
    ...
    _GOGETA_VERSION = "0.0.0"

_APP_VERSION = _GOGETA_VERSION
_BOT_VERSION = _GOGETA_VERSION
_YUANBAO_INSTANCE_ID = str(GOGETA_INSTANCE_ID)  # single source: yuanbao_proto.GOGETA_INSTANCE_ID
