...
Trust levels:
  - builtin:   Ships with Gogeta. Never scanned, always trusted.
...
THREAT_PATTERNS = [
    ...
    (r'\$HOME/\.gogeta/\.env|\~/\.gogeta/\.env',
     "gogeta_env_access", "critical", "exfiltration",
     "directly references Gogeta secrets file"),
    ...
    (r'\.gogeta/config\.yaml|\.gogeta/SOUL\.md',
     "gogeta_config_mod", "critical", "persistence",
     "references Gogeta configuration files directly"),
...
# scan. `.skillignore` is the Gogeta-native name; `.clawhubignore` is honored
