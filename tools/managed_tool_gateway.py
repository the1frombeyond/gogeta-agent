...
_DEFAULT_TOOL_GATEWAY_DOMAIN = "gogeta.ai"
...
def auth_json_path():
    ...
    """Return the Gogeta auth store path, respecting GOGETA_HOME overrides."""

    return get_gogeta_home() / "auth.json"
...
def peek_nous_access_token() -> Optional[str]:
    ...
    Availability scans (`gogeta tools`, banner/status paint, provider
...
def read_nous_access_token() -> Optional[str]:
    ...
    try:
        ...
        from gogeta_cli.auth import resolve_nous_access_token
