...
# regardless of approval level (e.g. logout kills the session Gogeta runs in).
...
def _get_backend() -> ComputerUseBackend:
    ...
    with _backend_lock:
        ...
        if _backend is None:
            ...
            backend_name = os.environ.get("GOGETA_COMPUTER_USE_BACKEND", "cua").lower()
            ...
            if backend_name in {"cua", "cua-driver", ""}:
                ...
                raise RuntimeError(f"Unknown GOGETA_COMPUTER_USE_BACKEND={backend_name!r}")
...
def handle_computer_use(args: Dict[str, Any], **kwargs) -> Any:
    ...
    try:
        ...
        return json.dumps({
            ...
            "hint": "Run `gogeta tools` and enable Computer Use to install cua-driver.",
...
def _route_capture_through_aux_vision(
    ...
    The captured base64 PNG is materialised to ``$GOGETA_HOME/cache/vision/``
    ...
    try:
        ...
        cache_dir = get_gogeta_dir("cache/vision", "temp_vision_images")
