...
the get_anchored_view / get_messages_around primitives in gogeta_state.
...
# Third-party integrations tag their sessions with GOGETA_SESSION_SOURCE=tool
...
def check_session_search_requirements() -> bool:
    ...
    try:
        from gogeta_state import DEFAULT_DB_PATH
    ...
    "parameters": {
        ...
        "properties": {
            ...
            "profile": {
                "type": "string",
                "description": (
                    "Optional. Read sessions from another Gogeta profile's database "
