...
version: 0.1.0
author: Hugo Sequier (Hugo-SEQUIER), Gogeta Agent
license: MIT
...
The script reads `~/.gogeta/.env` for two optional defaults:
...
Helper script: `~/.gogeta/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py`
...
```bash
python3 ~/.gogeta/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py <command> [args]
```
...
optional when `HYPERLIQUID_USER_ADDRESS` is set in `~/.gogeta/.env`.
...
```bash
python3 ~/.gogeta/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py dexs

python3 ~/.gogeta/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py \
