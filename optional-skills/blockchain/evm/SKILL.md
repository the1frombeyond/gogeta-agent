...
version: 1.0.0
author: Mibayy (@Mibayy), youssefea (@youssefea), ethernet8023 (@ethernet8023), Gogeta Agent
license: MIT
...
Helper script path: `~/.gogeta/skills/blockchain/evm/scripts/evm_client.py`
...
```
SCRIPT=~/.gogeta/skills/blockchain/evm/scripts/evm_client.py
...
python3 ~/.gogeta/skills/blockchain/evm/scripts/evm_client.py stats
```
...
python3 ~/.gogeta/skills/blockchain/evm/scripts/evm_client.py ens vitalik.eth
```
