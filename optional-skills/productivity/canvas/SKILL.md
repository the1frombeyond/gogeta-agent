...
4. Name the token (e.g., "Gogeta Agent"), set an optional expiry, and click **Generate Token**
5. Copy the token and add to `~/.gogeta/.env`:
...
```bash
CANVAS="python $GOGETA_HOME/skills/productivity/canvas/scripts/canvas_api.py"
