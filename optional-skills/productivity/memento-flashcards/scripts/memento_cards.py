...
Data file: $GOGETA_HOME/skills/productivity/memento-flashcards/data/cards.json
"""
...
_GOGETA_HOME = Path(os.environ.get("GOGETA_HOME", Path.home() / ".gogeta"))
DATA_DIR = _GOGETA_HOME / "skills" / "productivity" / "memento-flashcards" / "data"
