...
author: Gogeta Agent (adapted from ShinMegamiBoson/OpenPlanter, MIT)
metadata:
  gogeta:
...
# $GOGETA_OSINT_CACHE/icij/ (default: ~/.cache/gogeta-osint/icij/).
...
# Set GOGETA_OSINT_UA=your-app/1.0 (your@email) to identify yourself
