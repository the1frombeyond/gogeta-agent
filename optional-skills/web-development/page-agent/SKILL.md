...
- User wants **Gogeta itself to drive a browser** → use Gogeta' built-in browser tool (Browserbase / Camofox). page-agent is the *opposite* direction.
