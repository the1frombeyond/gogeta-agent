#!/usr/bin/env python3
"""
stocks_client.py - Stock market data CLI tool for the Gogeta Agent project.
...
USER_AGENT = "Mozilla/5.0 (compatible; GsaAgent/1.0)"
...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        prog="stocks_client",
        description="Stock & crypto market data CLI — Gogeta Agent",
