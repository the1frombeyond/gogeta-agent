...
version: 0.1.0
author: Mibay (Mibayy), Gogeta Agent
license: MIT
...
```
SCRIPT=~/.gogeta/skills/finance/stocks/scripts/stocks_client.py
...
```
python3 ~/.gogeta/skills/finance/stocks/scripts/stocks_client.py quote AAPL
```
