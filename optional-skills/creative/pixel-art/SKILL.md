...
```python
import sys
sys.path.insert(0, "/home/teknium/.gogeta/skills/creative/pixel-art/scripts")
...
```bash
cd /home/teknium/.gogeta/skills/creative/pixel-art/scripts
...
- ffmpeg on PATH (only needed for video — Gogeta installs package this)
