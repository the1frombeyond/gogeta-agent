...
from gogeta_cli.models import validate_requested_model
...
class TestMiniMaxModelValidation:
    ...
    def _isolate_minimax(self):
        ...
        with patch("gogeta_cli.models.fetch_api_models", return_value=None), \
             patch("gogeta_cli.models.probe_api_models", return_value=probe_payload):
            yield
