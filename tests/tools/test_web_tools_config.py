...
class TestFirecrawlClientConfig:
    ...
    def test_tool_gateway_domain_builds_firecrawl_gateway_origin(self):
        ...
        with patch.dict(os.environ, {"TOOL_GATEWAY_DOMAIN": "gogeta.ai"}):
            ...
            with patch("tools.web_tools._read_nous_access_token", return_value="nous-token"):
                ...
                with patch("tools.web_tools.Firecrawl") as mock_fc:
                    ...
                    mock_fc.assert_called_once_with(
                        ...
                        api_url="https://firecrawl-gateway.gogeta.ai",
            ...
            with patch("tools.web_tools._read_nous_access_token", return_value="nous-token"):
                ...
                with patch("tools.web_tools.Firecrawl") as mock_fc:
                    ...
                    mock_fc.assert_called_once_with(
                        ...
                        api_url="http://firecrawl-gateway.gogeta.ai",
    ...
    def test_nous_auth_token_respects_gogeta_home_override(self, tmp_path):

        """Auth lookup should read from GOGETA_HOME/auth.json, not ~/.gogeta/auth.json."""

        real_home = tmp_path / "real-home"

        (real_home / ".gogeta").mkdir(parents=True)
...
class TestBackendSelection:
    ...
    ``gogeta tools``.  Falls back to key-based detection for legacy/manual
...
class TestCheckWebApiKey:
    ...
    def test_tool_gateway_availability_skips_refresh_for_expired_cached_token(
        ...
        monkeypatch.setattr(
            ...
            "gogeta_cli.auth.resolve_nous_access_token",
