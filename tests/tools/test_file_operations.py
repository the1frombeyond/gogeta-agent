...
class TestIsWriteDenied:
    ...
    def test_gogeta_control_files_oauth_and_mcp_tokens_denied(self, path):

        """Gogeta control files, PKCE creds, mcp-tokens, and pairing entries must be write-denied."""

        from gogeta_constants import get_gogeta_home

        gogeta_home = get_gogeta_home()

        full_path = str(gogeta_home / path)
    ...
    def test_gogeta_control_files_and_oauth_traversal_denied(self, path):

        """Path traversal attempts to protected Gogeta files must be blocked."""
    ...
    def test_control_files_and_oauth_protected_in_profile_mode(self, tmp_path, monkeypatch, name):
        ...
        global ~/.gogeta/{auth.json,config.yaml,webhook_subscriptions.json,
        ...
        # Simulate a profile-mode GOGETA_HOME layout:
    ...
    def test_pairing_dir_denied(self, tmp_path, monkeypatch):
        ...
        PR #30383 introduced ~/.gogeta/pairing/{platform}-approved.json as the
...
class TestShellFileOpsHelpers:
    ...
    def test_read_file_strips_leaked_terminal_fence_markers(self, mock_env):
        ...
        leaked = (
            ...
            "'\x07__GOGETA_FENCE_a9f7b3__\x1b]0;cat "

            "'/tmp/test/a.py' 2> /dev/null\x07\n"

            "print('ok')\n"

            "__GOGETA_FENCE_a9f7b3__\x07'\n"
        ...
        assert "GOGETA_FENCE" not in result.content
    ...
    def test_read_file_raw_strips_leaked_terminal_fence_markers(self, mock_env):
        ...
        leaked = (
            ...
            "\x1b]0;cat '/tmp/test/a.txt'\x07__GOGETA_FENCE_a9f7b3__\n"
