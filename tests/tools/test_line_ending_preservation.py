...
@pytest.fixture
def gogeta_home(monkeypatch, tmp_path):
    """Isolate GOGETA_HOME so the tests don't pollute the real config.
...
class TestPatchCRLFPreservation:
    def test_patch_on_crlf_file_stays_pure_crlf(self, gogeta_home, tmp_path):
    ...
    def test_patch_on_lf_file_stays_lf(self, gogeta_home, tmp_path):
    ...
    def test_patch_multiline_replacement_on_crlf(self, gogeta_home, tmp_path):
...
class TestWriteFileCRLFPreservation:
    ...
    def test_new_file_written_as_is(self, gogeta_home, tmp_path):
    ...
    def test_overwrite_lf_file_stays_lf(self, gogeta_home, tmp_path):
