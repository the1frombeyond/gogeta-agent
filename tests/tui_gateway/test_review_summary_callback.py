...
def server():
    ...
    with patch.dict(
...

        {
            ...
            "gogeta_constants": MagicMock(

                get_gogeta_home=MagicMock(return_value="/tmp/gogeta_test_review_summary")
...
def test_init_session_attaches_background_review_callback(server, monkeypatch):
    ...
    cb("💾 Self-improvement review: Skill 'gogeta-release' patched")
    ...
    assert payload == {
        ...
        "text": "💾 Self-improvement review: Skill 'gogeta-release' patched"
