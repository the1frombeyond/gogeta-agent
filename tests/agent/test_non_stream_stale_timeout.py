...
def _write_config(tmp_path: Path, body: str) -> None:
    gogeta_home = tmp_path
    (gogeta_home / "config.yaml").write_text(body or "{}\n", encoding="utf-8")
...
def test_default_base_is_90s(monkeypatch, tmp_path):
    ...
    monkeypatch.delenv("GOGETA_API_CALL_STALE_TIMEOUT", raising=False)
...
""")
    ...
    import importlib
    from gogeta_cli import timeouts as to_mod
