...
The unit tests in tests/gogeta_cli/test_service_manager.py exercise the
...
docstring. ``/run/service`` is chowned gogeta-writable by the
...
_REGISTER_SCRIPT = """
import sys
sys.path.insert(0, "/opt/gogeta")
from gogeta_cli.service_manager import S6ServiceManager
