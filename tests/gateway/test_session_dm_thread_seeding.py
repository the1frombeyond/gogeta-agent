...
def store(tmp_path, monkeypatch):
    ...
    ~/.gogeta/state.db. (DEFAULT_DB_PATH is a module-level constant computed
    at gogeta_state import time, before pytest's GOGETA_HOME monkeypatch
    fires — the autouse fixture's GOGETA_HOME override doesn't help here.)
    """
    import gogeta_state
