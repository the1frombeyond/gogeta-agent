...
def gateway_home(monkeypatch, tmp_path):
    ...
    monkeypatch.delenv("GOGETA_PREFILL_MESSAGES_FILE", raising=False)
    monkeypatch.delenv("GOGETA_EPHEMERAL_SYSTEM_PROMPT", raising=False)
    ...
    monkeypatch.delenv("GOGETA_BACKGROUND_NOTIFICATIONS", raising=False)
    return tmp_path
