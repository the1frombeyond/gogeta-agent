...
def worker_loop(worker_id: int, gogeta_home: str, result_file: str) -> None:
...
def reclaimer_loop(gogeta_home: str, result_file: str) -> None:
...
def main():
    home = tempfile.mkdtemp(prefix="gogeta_mixed_stress_")
    print(f"GOGETA_HOME = {home}")
