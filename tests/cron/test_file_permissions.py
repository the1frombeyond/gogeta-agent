...
class TestConfigFilePermissions(unittest.TestCase):
    ...
    def test_save_config_sets_0600(self):
        ...
        with patch("gogeta_cli.config.get_config_path", return_value=config_path), \
             patch("gogeta_cli.config.ensure_gogeta_home"):
    ...
    def test_save_env_value_sets_0600(self):
        ...
        with patch("gogeta_cli.config.get_env_path", return_value=env_path), \
             patch("gogeta_cli.config.ensure_gogeta_home"):
    ...
    def test_ensure_gogeta_home_sets_0700(self):
        home = Path(self.tmpdir) / ".gogeta"
        with patch("gogeta_cli.config.get_gogeta_home", return_value=home):
