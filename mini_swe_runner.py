#!/usr/bin/env python3
"""
SWE Runner with Gogeta Trajectory Format

A runner that uses Gogeta-Agent's built-in execution environments
(local, docker, modal) and outputs trajectories in the Gogeta-Agent format
compatible with batch_runner.py and trajectory_compressor.py.

Features:
- Uses Gogeta-Agent's Docker, Modal, or Local environments for command execution
- Outputs trajectories in Gogeta format (from/value pairs with <tool_call>/<tool_response> XML)
...
# ============================================================================
# Terminal Tool Definition (matches Gogeta-Agent format)
# ============================================================================
...
def create_environment(
    ...
    **kwargs
    ...
    """
    Create an execution environment using Gogeta-Agent's built-in backends.
...
# ============================================================================
# Mini-SWE Runner with Gogeta Trajectory Format
# ============================================================================

class MiniSWERunner:
    """
    Agent runner that uses Gogeta-Agent's built-in execution environments
    and outputs trajectories in Gogeta-Agent format.
    """
    ...
    def _convert_to_gogeta_format(
        ...
        """
        Convert internal message format to Gogeta trajectory format.
...
Complete the user's task step by step."""
        ...
        # Convert to Gogeta trajectory format
        trajectory = self._convert_to_gogeta_format(messages, task, completed)
...
def main(
    ...
    """
    Run SWE tasks with Gogeta trajectory format output.
    ...
    """
    print("🚀 Mini-SWE Runner with Gogeta Trajectory Format")
    print("=" * 60)
