...
projection into Gogeta' display, approval bridging, transcript projection into
...
"codex_app_server"`. Gogeta' default tool dispatch is unchanged when this
...
class CodexAppServerClient:
    ...
    def __init__(
        ...
        if spawn_env.get("GOGETA_KANBAN_TASK"):
            kanban_db = spawn_env.get("GOGETA_KANBAN_DB")
            kanban_root = (
                ...
                if kanban_db
                    ...
                    "GOGETA_KANBAN_ROOT",
                    os.path.join(
                        spawn_env.get("GOGETA_HOME", os.path.expanduser("~/.gogeta")),
                        "kanban",
                    ),
                )
            )
    ...
    def initialize(
        self,
        client_name: str = "gogeta",
        client_title: str = "Gogeta Agent",
