...
(3 SDK retries x 3 Gogeta retries), and every one of those calls counts
...
def _state_path() -> str:
    ...
    try:
        ...
        base = get_gogeta_home()
    except ImportError:
        base = os.path.join(os.path.expanduser("~"), ".gogeta")
...
def is_genuine_nous_rate_limit(
    *,
    ...
    MiMo, Gogeta, ...) behind one endpoint.  A 429 can mean either:
