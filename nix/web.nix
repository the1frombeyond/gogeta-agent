# nix/web.nix — Gogeta Web Dashboard (Vite/React) frontend build
{ pkgs, gsaNpmLib, ... }:
let
  npm = gsaNpmLib.mkNpmPassthru { folder = "web"; attr = "web"; pname = "gogeta-web"; };
...
pkgs.buildNpmPackage (npm // {
  ...
  buildPhase = ''
    ...
    # outDir in vite.config.ts points to ../gogeta_cli/web_dist for the
