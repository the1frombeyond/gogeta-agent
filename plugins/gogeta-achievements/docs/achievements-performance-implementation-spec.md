# Gogeta Achievements Implementation Spec (Detailed)
...
- persisted runtime files:
  - `~/.gogeta/plugins/gogeta-achievements/state.json` (existing unlock state)
  - `~/.gogeta/plugins/gogeta-achievements/scan_snapshot.json` (new)
  - `~/.gogeta/plugins/gogeta-achievements/scan_checkpoint.json` (new)
