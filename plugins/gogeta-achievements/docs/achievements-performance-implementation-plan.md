# Gogeta Achievements Performance Implementation Plan
...
- Snapshot persisted at `~/.gogeta/plugins/gogeta-achievements/scan_snapshot.json`.
...
Acceptance:
- Checkpoint persisted at `~/.gogeta/plugins/gogeta-achievements/scan_checkpoint.json`.
