...
``_check_spotify_available()`` — when the user has not run ``gogeta auth
spotify``, the tools remain registered (so they appear in ``gogeta
...
The Spotify auth flow (``gogeta auth spotify``), CLI plumbing, and docs
