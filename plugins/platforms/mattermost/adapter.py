...
required — uses aiohttp which is already a Gogeta dependency.
...
def interactive_setup() -> None:
    ...
    ``gogeta_cli/setup.py::_setup_mattermost`` function this migration
    removes.
    """
    ...
    print()
    print_info("📬 Home Channel: where Gogeta delivers cron job results and notifications.")
...
def register(ctx) -> None:
    ...
    ctx.register_platform(
        ...
        # gogeta_cli/setup.py::_setup_mattermost function.
