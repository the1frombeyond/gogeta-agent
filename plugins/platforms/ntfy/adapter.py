"""ntfy platform adapter (Gogeta plugin).
...
``plugins/platforms/ntfy/``. The Gogeta plugin loader scans the
    ...
    platforms:
      ntfy:
        ...
        extra:
          ...
          topic: "gogeta-in"              # subscribe topic (incoming)
          publish_topic: "gogeta-out"     # optional — defaults to topic
...
_ECHO_TAG = "gogeta-agent"  # tag added to outgoing messages for echo-loop prevention
...
async def _standalone_send(
    ...
    *,
    ...
    ``gogeta cron`` running standalone). Without this hook,
...
def register(ctx) -> None:
    ...
    ctx.register_platform(
        ...
        install_hint="pip install httpx   # already a Gogeta dependency",
