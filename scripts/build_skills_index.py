#!/usr/bin/env python3
"""Build the Gogeta Skills Index — a centralized JSON catalog of all skills.
...
`gogeta skills search/install` can use it without hitting the GitHub API.
...
# Ensure GOGETA_HOME is set (needed by tools/skills_hub.py imports)
...
def main():
    print("Building Gogeta Skills Index...", flush=True)
