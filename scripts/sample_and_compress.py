...
DEFAULT_DATASETS = [
    ...
    "NousResearch/gogeta-megascience-sft1",
    "NousResearch/Gogeta-Agent-Thinking-GLM-4.7-SFT2",
    "NousResearch/Gogeta-Agent-Thinking-GLM-4.7-SFT1",
    "NousResearch/terminal-tasks-glm-gogeta-agent"
]
