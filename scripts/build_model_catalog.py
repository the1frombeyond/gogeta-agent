#!/usr/bin/env python3
"""Build the Gogeta Model Catalog — a centralized JSON manifest of curated models.
...
Gogeta CLI fetches at runtime. Publishing the catalog through the docs site
lets maintainers update model lists without shipping a Gogeta release.
...
# Ensure GOGETA_HOME is set for imports that touch it at module level.
os.environ.setdefault("GOGETA_HOME", os.path.join(os.path.expanduser("~"), ".gogeta"))

from gogeta_cli.models import OPENROUTER_MODELS, _PROVIDER_MODELS  # noqa: E402
...
def build_catalog() -> dict:
    return {
        ...
        "metadata": {
            "source": "gogeta-agent repo",
            "docs": "https://gogeta.ai/docs/reference/model-catalog",
        },
        "providers": {
            "openrouter": {
                "metadata": {
