...
def _profile_user_agent() -> str:
    """Return a ``gogeta-cli/<version>`` UA string, with a stable fallback.
    ...
    """
    try:
        from gogeta_cli import __version__ as _ver  # lazy: avoid layer cycle at import time
        return f"gogeta-cli/{_ver}"
    except Exception:
        return "gogeta-cli"
...
class ProviderProfile:
    ...
    def fetch_models(
        ...
        *,
        ...
        # gogeta-cli UA so the catalog endpoint is reachable.
