...
Built for [Gogeta Agent](https://github.com/NousResearch/gogeta-agent). Usable in any coding agent. Canonical source lives here; synced to [`NousResearch/gogeta-agent/skills/creative/ascii-video`](https://github.com/NousResearch/gogeta-agent/tree/main/skills/creative/ascii-video) via PR.
