...
```bash
python3 -m pyfiglet "GOGETA" -f slant | boxes -d stone
# Or without pyfiglet installed:
curl -s "https://asciified.thelicato.io/api/v2/ascii?text=GOGETA&font=Slant" | boxes -d stone
```
