...
cd apps/desktop
XCURSOR_SIZE=24 GOGETA_DESKTOP_DEV_SERVER=http://127.0.0.1:5174 \
...
node apps/desktop/scripts/profile-typing.mjs \
  --chars=400 --cps=30 --out=/tmp/gogeta-typing
# → /tmp/gogeta-typing.cpuprofile  (open in Chrome DevTools Performance)
# → /tmp/gogeta-typing.before.heapsnapshot
# → /tmp/gogeta-typing.after.heapsnapshot
```
