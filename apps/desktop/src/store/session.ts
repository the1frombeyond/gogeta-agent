...
import type { SessionInfo, UsageStats } from '@/types/gogeta'

type Updater<T> = T | ((current: T) => T)

const WORKSPACE_CWD_KEY = 'gogeta.desktop.workspace-cwd'
...
export const $connection = atom<GsaConnection | null>(null)
...
export const setConnection = (next: Updater<GsaConnection | null>) => updateAtom($connection, next)
