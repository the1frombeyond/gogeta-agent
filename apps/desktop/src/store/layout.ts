...
const SIDEBAR_PINNED_STORAGE_KEY = 'gogeta.desktop.pinnedSessions'
const SIDEBAR_AGENTS_GROUPED_STORAGE_KEY = 'gogeta.desktop.agentsGroupedByWorkspace'
const SIDEBAR_CRON_OPEN_STORAGE_KEY = 'gogeta.desktop.sidebarCronOpen'
const PANES_FLIPPED_STORAGE_KEY = 'gogeta.desktop.panesFlipped'
...
export const SESSION_SEARCH_FOCUS_EVENT = 'gogeta:focus-session-search'
