...
const desktopWindow = window as unknown as { gsaDesktop?: Window['gsaDesktop'] }
const initialGsaDesktop = desktopWindow.gsaDesktop

function installDesktopBridge(partial: Partial<Window['gsaDesktop']> = {}) {
  desktopWindow.gsaDesktop = {
    fetchLinkTitle: vi.fn().mockResolvedValue(''),
    openExternal: vi.fn().mockResolvedValue(undefined),
    ...partial
  } as unknown as Window['gsaDesktop']
}
...
afterEach(() => {
  ...
  if (initialGsaDesktop) {
    desktopWindow.gsaDesktop = initialGsaDesktop
  } else {
    delete desktopWindow.gsaDesktop
  }
})
...
describe('external link helpers', () => {
  ...
  it('deduplicates in-flight title fetches and caches results', async () => {
    ...
    installDesktopBridge({ fetchLinkTitle: bridge as unknown as Window['gsaDesktop']['fetchLinkTitle'] })
  ...
  it('opens links via the desktop bridge', () => {
    ...
    installDesktopBridge({ openExternal: openExternal as unknown as Window['gsaDesktop']['openExternal'] })
