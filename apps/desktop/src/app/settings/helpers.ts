import type { GsaConfigRecord, ToolsetInfo } from '@/types/gogeta'
...
export function getNested(obj: GsaConfigRecord, path: string): unknown {
  let cur: unknown = obj
...
export function setNested(obj: GsaConfigRecord, path: string, value: unknown): GsaConfigRecord {
...
function personalityOptions(config: GsaConfigRecord): string[] {
