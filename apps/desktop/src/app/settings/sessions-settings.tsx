...
import { deleteSession, listSessions, setSessionArchived } from '@/gogeta'
...
import type { SessionInfo } from '@/types/gogeta'
...
// / Program Files), which buried any files Gogeta wrote there.
function DefaultProjectDirSetting() {
  ...
  useEffect(() => {
    ...
    // / Storybook / non-Electron context `window.gsaDesktop` is
    ...
    const settings = window.gsaDesktop?.settings
  ...
  return (
    <div className="mb-6">
      ...
      <ListRow
        ...
        description={dir || s.defaultsTo(fallback || '~/gogeta-projects')}
