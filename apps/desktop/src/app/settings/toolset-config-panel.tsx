...
import type { ActionStatusResponse, ToolEnvVar, ToolProvider, ToolsetConfig } from '@/types/gogeta'
 ...
 * log inline — the GUI equivalent of the install step `gogeta tools` runs
