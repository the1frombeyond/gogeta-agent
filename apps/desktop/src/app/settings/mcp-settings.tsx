...
import { getGsaConfigRecord, type GsaGateway, saveGsaConfig } from '@/gogeta'
...
function getServers(config: GsaConfigRecord | null): McpServers {
...
export function McpSettings({ gateway, onConfigSaved }: McpSettingsProps) {
  ...
  const saveServer = async () => {
    ...
    try {
      ...
      await saveGsaConfig(nextConfig)
