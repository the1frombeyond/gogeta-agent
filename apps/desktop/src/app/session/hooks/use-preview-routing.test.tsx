...
describe('usePreviewRouting', () => {
  beforeEach(() => {
    ...
    Object.defineProperty(window, 'gsaDesktop', {
      configurable: true,
      value: {
  ...
  it('does not infer previews from assistant prose', async () => {
    ...
    expect(window.gsaDesktop.normalizePreviewTarget).not.toHaveBeenCalled()
  })
  ...
  it('registers structured tool-result preview targets', async () => {
    ...
    expect(window.localStorage.getItem('gogeta.desktop.sessionPreviews.v1')).toContain('./dist/index.html')
  })
