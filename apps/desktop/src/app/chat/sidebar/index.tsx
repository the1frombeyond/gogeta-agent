...
import { searchSessions, type SessionInfo, type SessionSearchResult } from '@/gogeta'
...
export function ChatSidebar({
  ...
  useEffect(() => {
    ...
    window.addEventListener('gogeta:new-session-shortcut', onShortcut)

    return () => {
      window.removeEventListener('gogeta:new-session-shortcut', onShortcut)
      clearTimeout(timeout)
    }
  }, [])
