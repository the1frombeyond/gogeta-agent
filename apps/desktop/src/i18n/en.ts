...
export const en: Translations = {
  ...
  boot: {
    ready: 'Gogeta Desktop is ready',
    desktopBootFailedWithMessage: message => `Desktop boot failed: ${message}`,
    steps: {
      connectingGateway: 'Connecting live desktop gateway',
      loadingSettings: 'Loading Gogeta settings',
      loadingSessions: 'Loading recent sessions',
      startingDesktopConnection: 'Starting desktop connection',
      startingGsaDesktop: 'Starting Gogeta Desktop…'
    },
    errors: {
      backgroundExited: 'Gogeta background process exited.',
      backgroundExitedDuringStartup: 'Gogeta background process exited during startup.',
  ...
  notifications: {
    ...
    backendOutOfDateMessage:
      'Your Gogeta backend is older than this desktop build and may not work correctly. Update to align them.',
    updateGsa: 'Update Gogeta',
    ...
    errors: {
      ...
      methodNotAllowed:
        'The desktop backend rejected that request (405 Method Not Allowed). Try restarting Gogeta Desktop.',
  ...
  settings: {
    ...
    resetConfirm: 'Reset all settings to Gogeta defaults?',
    ...
    appearance: {
      ...
      colorModeDesc: 'Pick a fixed mode or let Gogeta follow your system setting.',
    ...
    about: {
      ...
      automaticUpdatesDesc:
        'Gogeta checks for updates automatically in the background and lets you know when one is ready.',
    ...
    config: {
      ...
      loading: 'Loading Gogeta configuration...',
    ...
    gateway: {
      ...
      intro:
        'Gogeta Desktop starts its own local gateway by default. Use a remote gateway when you want this app to control an already-running Gogeta backend on another machine or behind a trusted proxy. Pick a profile below to give it its own remote host.',
      ...
      envOverrideDesc:
        'Unset GOGETA_DESKTOP_REMOTE_URL and GOGETA_DESKTOP_REMOTE_TOKEN to use the saved setting below.',
      localTitle: 'Local gateway',
      localDesc: 'Start a private Gogeta backend on localhost. This is the default and works offline.',
      remoteTitle: 'Remote gateway',
      remoteDesc:
        'Connect this desktop shell to a remote Gogeta backend. Hosted gateways use OAuth or a username and password; self-hosted ones may use a session token.',
      remoteUrlTitle: 'Remote URL',
      remoteUrlDesc: 'Base URL for the remote dashboard backend. Path prefixes are supported, for example /gogeta.',
      ...
      restartingMessage: 'Gogeta Desktop will reconnect using the saved settings.',
      savedMessage: 'Saved for the next restart.',
      connectedTo: (baseUrl, version) => `Connected to ${baseUrl}${version ? ` · Gogeta ${version}` : ''}`,
    ...
    providers: {
      ...
      intro:
        'Sign in with a subscription — no API key to copy. Gogeta runs the browser sign-in for you, right here in the app.',
      connected: 'Connected',
      collapse: 'Collapse',
  ...
  commandCenter: {
    ...
    nav: {
      ...
      settings: { title: 'Settings', detail: 'Configure Gogeta desktop' },
    ...
    gsaActiveSessions: (version, count) => `Gogeta ${version} · Active sessions ${count}`,
  ...
  messaging: {
    ...
    fieldCopy: {
      ...
      MATRIX_USER_ID: { label: 'Bot user ID', placeholder: '@gogeta:example.org' },
  ...
  profiles: {
    ...
    deleting: 'Deleting...',
    createDesc: 'Profiles are independent Gogeta environments: separate config, skills, and SOUL.md.',
    nameLabel: 'Name',
  ...
  cron: {
    ...
    newCron: 'New cron',
    emptyDescNew:
      'Schedule a prompt to run on a cron expression. Gogeta will run it and deliver results to the destination you pick.',
  ...
  composer: {
    ...
    placeholderStarting: 'Starting Gogeta...',
    placeholderReconnecting: 'Reconnecting to Gogeta…',
    ...
    attachUrlDesc: 'Gogeta will fetch the page and include it as context for this turn.',
  ...
  updates: {
    ...
    unsupportedMessage: 'This version of Gogeta can’t update itself from inside the app.',
    connectionRetry: 'Check your connection and try again.',
    latestBody: 'You’re running the latest version.',
    allSetTitle: 'You’re all set',
    availableTitle: 'New update available',
    availableBody: 'A new version of Gogeta is ready to install.',
    updateNow: 'Update now',
    maybeLater: 'Maybe later',
    moreChanges: count => `+ ${count} more change${count === 1 ? '' : 's'} included.`,
    manualTitle: 'Update from your terminal',
    manualBody: 'You installed Gogeta from the command line, so updates run there too. Paste this into your terminal:',
    manualPickedUp: 'Gogeta will pick up the new version next time you launch it.',
    copy: 'Copy',
    copied: 'Copied',
    done: 'Done',
    applyingBody: 'The Gogeta updater will take over in its own window and reopen Gogeta when it’s done.',
    applyingClose: 'Gogeta will close to apply the update.',
  ...
  install: {
    ...
    oneTimeTitle: 'Gogeta needs a one-time install',
    ...
    settingUpTitle: 'Setting up Gogeta Agent',
    finishingTitle: 'Finishing up',
    failedDesc:
      'One of the install steps failed. On Windows, this can happen if another Gogeta CLI or desktop instance is running. Stop any running Gogeta instances, then retry. Check the details below or the desktop log for the full transcript.',
    activeDesc:
      'This is a one-time setup. The Gogeta installer is downloading dependencies and configuring your machine. Subsequent launches will skip this step.',
  ...
  onboarding: {
    headerTitle: "Let's get you setup with Gogeta Agent",
    headerDesc: 'Connect a model provider to start chatting. Most options take one click.',
    preparingInstall: 'Gogeta is finishing install. This usually takes under a minute on first run.',
    starting: 'Starting Gogeta…',
    ...
    recommended: 'Recommended',
    connected: 'Connected',
    featuredPitch: 'One subscription, 300+ frontier models — the recommended way to run Gogeta',
    ...
    apiKeyOptions: {
      ...
      local: {
        short: 'self-hosted',
        description: 'Point Gogeta at a local or self-hosted OpenAI-compatible endpoint (vLLM, llama.cpp, Ollama, etc).'
      }
    },
    ...
    flowSubtitles: {
      ...
      device_code: 'Opens a verification page in your browser — Gogeta connects automatically',
      loopback: 'Opens your browser to sign in — Gogeta connects automatically',
    ...
    authorizeThere: 'Authorize Gogeta there.',
    ...
    autoBrowser: provider =>
      `We opened ${provider} in your browser. Authorize Gogeta there and you'll be connected automatically — nothing to copy or paste.`,
  ...
  shell: {
    ...
    statusbar: {
      ...
      desktopVersion: version => `Gogeta Desktop v${version}`,
      ...
      gatewayTitle: 'Gogeta inference gateway status',
      agents: 'Agents',
  ...
  preview: {
    ...
    largeBody: (label, size) => `${label} is ${size}. Gogeta will only show the first 512 KB.`,
    ...
    web: {
      ...
      tryAgain: 'Try again',
      restarting: 'Gogeta is restarting...',
      askRestart: 'Ask Gogeta to restart the server',
      lookingRestart: taskId => `Gogeta is looking for a preview server to restart (${taskId})`,
      restartingTitle: 'Restarting preview server',
      restartingMessage: 'Gogeta is working in the background. Watch the preview console for progress.',
      ...
      finishedRestarting: message => `Gogeta finished restarting the preview server${message ? `: ${message}` : ''}`,
      ...
      restartFailedMessage: 'Gogeta could not restart the server.',
      stillWorking:
        'Gogeta is still working, but no restart result has arrived yet. The server command may be running in the foreground.',
  ...
  assistant: {
    thread: {
      ...
      loadingResponse: 'Gogeta is loading a response',
      thinking: 'Thinking',
    ...
    approval: {
      gatewayDisconnected: 'Gogeta gateway is not connected',
      ...
      alwaysDescription: pattern =>
        `This adds the “${pattern}” pattern to your permanent allowlist (~/.gogeta/config.yaml). Gogeta won’t ask again for commands like this — in this session or any future one.`,
  ...
  prompts: {
    ...
    sudoDesc: 'Gogeta needs your sudo password to run a privileged command. It is sent only to your local agent.',
    sudoPlaceholder: 'sudo password',
    secretTitle: 'Secret required',
    secretDesc: 'Gogeta needs a credential to continue.',
  ...
  desktop: {
    ...
    restartToUseSaveImage: 'Restart Gogeta Desktop to use Save Image.',
    restartToSaveImages: 'Restart Gogeta Desktop to save images',
