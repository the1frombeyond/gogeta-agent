 ...
 * `_BUILTIN_DASHBOARD_THEMES` list in `gogeta_cli/web_server.py`.
 */
...
export const defaultTheme: DashboardTheme = {
  name: "default",
  label: "Gogeta Teal",
  description: "Classic dark teal — the canonical Gogeta look",
  palette: {
...
/**
 * Nous Blue — the inverted "light mode" Gogeta look, ported from the
 ...
 * nousnet-web's <body> is white; gogeta-agent's App root is `bg-black`,
...
export const defaultLargeTheme: DashboardTheme = {
  name: "default-large",
  label: "Gogeta Teal (Large)",
  description: "Gogeta Teal with bigger fonts and roomier spacing",
