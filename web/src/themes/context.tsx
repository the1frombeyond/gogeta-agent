...
const STORAGE_KEY = "gogeta-dashboard-theme";
...
const FONT_STORAGE_KEY = "gogeta-dashboard-font";
 ...
 *  `_THEME_NAMED_ASSET_KEYS` in `gogeta_cli/web_server.py`. */
...
const CUSTOM_CSS_STYLE_ID = "gogeta-theme-custom-css";
...
function applyCustomCSS(css: string | undefined) {
  ...
  if (!el) {
    ...
    el.setAttribute("data-gogeta-theme-css", "true");
...
function injectFontStylesheet(url: string | undefined) {
  ...
  link.rel = "stylesheet";
  link.href = url;
  link.setAttribute("data-gogeta-theme-font", "true");
