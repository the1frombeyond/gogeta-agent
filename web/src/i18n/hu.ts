...
export const hu: Translations = {
  ...
  status: {
    ...
    stopped: "Leállítva",
    updateGogeta: "Gogeta frissítése",
    updatingGogeta: "Gogeta frissítése…",
  ...
  pluginsPage: {
    ...
    headline:
      "Gogeta-bővítmények felfedezése, telepítése, engedélyezése és frissítése (a `gogeta plugins` paritás).",
    ...
    removeConfirm: "Eltávolítja ezt a bővítményt a ~/.gogeta/plugins/ mappából?",
    removeHint: "Csak a felhasználó által a ~/.gogeta/plugins alá telepített bővítmények távolíthatók el.",
  ...
  skills: {
    ...
    filters: "Szűrők",
    noSkills: "Nem található készség. A készségek a ~/.gogeta/skills/ mappából töltődnek be",
  ...
  achievements: {
    hero: {
      ...
      subtitle:
        "Gyűjthető Gogeta-jelvények, valós munkamenet-előzmények alapján szerezve. Az ismert, de még nem szerzett teljesítmények Felfedezettként jelennek meg; a Titkos teljesítmények rejtve maradnak az első egyező viselkedésig.",
      scan_subtitle:
        "Gogeta munkamenet-előzmények vizsgálata. Az első vizsgálat 5–10 másodpercig is eltarthat nagy előzmények esetén.",
    },
    actions: {
    ...
    stats: {
      ...
      latest: "Legutóbbi",
      latest_hint_empty: "futtasd többet a Gogetat",
      none_yet: "Még semmi",
    },
    state: {
      unlocked: "Feloldva",
    ...
    guide: {
      ...
      secret_body:
        "A titkos teljesítmények elrejtik a pontos kiváltó eseményt. Amint a Gogeta kapcsolódó jelet észlel, a kártya Felfedezettre vált, és megjeleníti a követelményt.",
      scan_status_header: "Vizsgálat állapota",
      scan_status_body:
        "A Gogeta egyszer átvizsgálja a helyi előzményeket, majd a kártyák automatikusan megjelennek. Semmi sem akadt el, ha ez néhány másodpercig tart.",
