...
export const tr: Translations = {
  ...
  status: {
    ...
    stopped: "Durduruldu",
    updateGogeta: "Gogeta'i Güncelle",
    updatingGogeta: "Gogeta güncelleniyor…",
  ...
  pluginsPage: {
    ...
    headline:
      "Gogeta eklentilerini keşfedin, yükleyin, etkinleştirin ve güncelleyin (`gogeta plugins` ile eşdeğer).",
    ...
    removeConfirm: "Bu eklenti ~/.gogeta/plugins/ içinden kaldırılsın mı?",
    removeHint: "Yalnızca ~/.gogeta/plugins altındaki kullanıcı tarafından yüklenmiş eklentiler kaldırılabilir.",
  ...
  skills: {
    ...
    filters: "Filtreler",
    noSkills: "Yetenek bulunamadı. Yetenekler ~/.gogeta/skills/ adresinden yüklenir",
  ...
  achievements: {
    hero: {
      ...
      subtitle:
        "Gerçek oturum geçmişinden kazanılan, koleksiyonluk Gogeta rozetleri. Bilinen ama henüz tamamlanmamış başarılar Keşfedildi olarak gösterilir; Gizli başarılar ilk eşleşen davranış görünene kadar saklı kalır.",
      scan_subtitle:
        "Gogeta oturum geçmişi taranıyor. Büyük geçmişlerde ilk tarama 5–10 saniye sürebilir.",
    },
    actions: {
      rescan: "Yeniden tara",
    },
    stats: {
      ...
      latest: "En son",
      latest_hint_empty: "Gogeta'i daha çok çalıştır",
      none_yet: "Henüz yok",
    },
    state: {
      unlocked: "Açıldı",
    ...
    guide: {
      ...
      secret_body:
        "Sırlar, tetikleyicilerini saklı tutar. Gogeta ilgili bir sinyal gördüğünde kart Keşfedildi durumuna geçer ve gereksinimini gösterir.",
      scan_status_header: "Tarama durumu",
      scan_status_body:
        "Gogeta yerel geçmişi bir kez tarıyor; sonra kartlar otomatik olarak görünür. Birkaç saniye sürmesi normaldir, hiçbir şey takılmadı.",
