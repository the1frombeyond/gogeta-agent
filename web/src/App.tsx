...
const SIDEBAR_COLLAPSED_KEY = "gogeta-sidebar-collapsed";
          ...
          >
            ...
            >
              ...
              {sidebarNav.pluginItems.length > 0 && (
                <div
                  aria-labelledby="gogeta-sidebar-plugin-nav-heading"
                ...
                >
                  <span
                    ...
                    id="gogeta-sidebar-plugin-nav-heading"
                  >
...
function SidebarSystemActions({
  ...
  const items: SystemActionItem[] = [
    ...
    },
    {
      action: "update",
      icon: Download,
      label: t.status.updateGogeta,
      runningLabel: t.status.updatingGogeta,
      spin: false,
    },
  ];
