 ...
 * `window.__GOGETA_PLUGINS__.registerSlot(pluginName, slotName, Component)`
 ...
 *  - `header-left`      — injected before the Gogeta brand in the top bar
 ...
 *  `window.__GOGETA_PLUGINS__.registerSlot(...)`.
 *
