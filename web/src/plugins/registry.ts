 ...
 *
 * Plugins call window.__GOGETA_PLUGINS__.register(name, Component)
 ...
 * Exposed at runtime as ``window.__GOGETA_PLUGIN_SDK__.sdkVersion`` so a
...
export function exposePluginSDK() {
  window.__GOGETA_PLUGINS__ = {
    register: registerPlugin,
    registerSlot,
  };

  window.__GOGETA_PLUGIN_SDK__ = {
    ...
    // window.__GOGETA_SESSION_TOKEN__ directly.
    authedFetch,
