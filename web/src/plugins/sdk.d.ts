/**
 * Gogeta Dashboard Plugin SDK — typed contract (SPIKE)
 * ====================================================
 *
 * This is the public type surface for ``window.__GOGETA_PLUGIN_SDK__`` and
 * ``window.__GOGETA_PLUGINS__``, the globals the dashboard host exposes to
 ...
 * window.__GOGETA_PLUGIN_SDK__`` because:
 ...
 *
 * Versioning: bump ``GogetaPluginSDK["sdkVersion"]`` (and the
 ...
 *   - Ship as a published ``@gogeta/dashboard-plugin-sdk`` types package, or
 ...
 * of calling ``fetch`` with a hand-read ``window.__GOGETA_SESSION_TOKEN__``.
 */
...
// ---------------------------------------------------------------------------
// Registry surface (window.__GOGETA_PLUGINS__)
// ---------------------------------------------------------------------------
...
// ---------------------------------------------------------------------------
// SDK surface (window.__GOGETA_PLUGIN_SDK__)
// ---------------------------------------------------------------------------

export interface GogetaPluginSDK {
...
declare global {
  interface Window {
    __GOGETA_PLUGIN_SDK__?: GogetaPluginSDK;
    __GOGETA_PLUGINS__?: PluginRegistry;
  }
}
