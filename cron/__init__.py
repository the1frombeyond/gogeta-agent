"""
Cron job scheduling system for Gogeta Agent.
...
Cron jobs are executed automatically by the gateway daemon:
    gogeta gateway install    # Install as a user service
    sudo gogeta gateway install --system  # Linux servers: boot-time system service
    gogeta gateway            # Or run in foreground
